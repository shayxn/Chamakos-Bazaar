    ...
    <div className="min-h-screen flex flex-col bg-black text-white overflow-x-hidden">
      ...
      {settings.whatsapp_visible !== "false" && settings.whatsapp_number && (
        <a
          ...
          className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 text-white font-black text-sm uppercase tracking-wider px-4 py-3 rounded-full shadow-[0_4px_20px_rgba(37,211,102,0.35)] transition-all hover:scale-105 hover:shadow-[0_8px_28px_rgba(37,211,102,0.45)]"
